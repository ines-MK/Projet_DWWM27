...
class HomeController extends AbstractController
{
    ...
    {
           $product = $productRepository->findBy([], ['name' => 'DESC', 'id' => 'DESC'], 3); // Fait un order By du createdAt en DESC et si il ont la meme date on fait un tri de l'id décroissant avec une limite de 8 produit => affiche les 8 derniers produits par id
